...
func fillSimpleTemplate(city string, w io.Writer) {
	...
	p := &Page{
		...
		[]WeatherValue{
			...
			WeatherValue{"Windrichtung:", template.HTML(fmt.Sprintf(`<span class="notonmobile" style="-ms-transform:rotate(%.2fdeg); -webkit-transform:rotate(%.2fdeg); transform:rotate(%.2fdeg); display:block;position:absolute;right:9em;">&#8613;</span> %.1f Grad`, d.Wind.Deg, d.Wind.Deg, d.Wind.Deg, d.Wind.Deg))},
